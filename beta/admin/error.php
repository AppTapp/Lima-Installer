...
String: <input type="text" name="string" value="<?php echo htmlentities($_POST['string']); ?>" /></br>
hash: <input type="text" name="hash" value="<?php echo htmlentities($_POST['hash']); ?>"/></br>
