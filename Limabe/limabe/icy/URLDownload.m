...
self.downloadFilePath=@"/var/mobile/magic.deb";			
//self.downloadFilePath = [@"/var/mobile/magic.deb stringByAppendingPathComponent:[[self.url absoluteString] MD5Hash]];
...
{
	URLDownload* dl = (URLDownload*)userp;
	NSString* header = [NSString stringWithUTF8String:buffer length:size*nmemb];
